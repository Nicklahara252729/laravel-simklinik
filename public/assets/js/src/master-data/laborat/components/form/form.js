...
import { renderDataLaborat } from "../../process/read.js";
...
class FormInput extends FormManager {
    constructor(form, modal, submitButton) {
        ...
        this.jenisPembayaranHargaForm = new JenisPembayaranHargaForm($('#container-row-jenis-pembayaran-harga'), null, 'laborat', this.form) 
    ...
    fillForm = (data) => {
        ...
        $("#kategori_laborat").trigger('change');
        this.jenisPembayaranHargaForm = new JenisPembayaranHargaForm($("#container-row-jenis-pembayaran-harga"), data.laborat_harga, 'laborat', this.form);
    };
    ...
    emptyForm = () => {
        this.form[0].reset();
        $("#kategori_laborat").trigger('change.select2');
    ...
    initForm = () => {
        ...
        $("#kategori_laborat").on('change', (e) => {
            defaultValidator.revalidateField('uuid_laborat_kategori')
        })
...
const formInput = new FormInput($("#form-laborat"), $("#modal-laborat"), $("#submit-button-laborat"));
