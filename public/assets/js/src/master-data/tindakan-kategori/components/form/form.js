import { renderDataTindakanKategori } from "../../process/read.js";
...
const formInput = new FormInput($("#form-tindakan-kategori"), $("#modal-tindakan-kategori"), $("#submit-button-tindakan-kategori"));
